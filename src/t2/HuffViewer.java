...
public class HuffViewer extends JFrame {
    ...
    private static final String HUFF_SUFFIX = ".hf";
    private static final String UNHUFF_SUFFIX = ".unhf"; 
    static final String SXGRAPH_SUFFIX = ".sgv";
        ...
        fileMenu.add(new AbstractAction("Compress") {
            public void actionPerformed(ActionEvent ev) {
                try {
                    ...
                    Logger.getLogger(HuffViewer.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    ...
    private void doSave() throws IOException  {
        ...
        String    ruta = myFile.getCanonicalPath();
            ...
            Thread fileWriterThread = new Thread() {
                public void run() {
                    try {
                        ...
                        ((SimpleHuffProcessor)myModel).compress(pmis, out,myForce,ruta);
                    } catch (IOException e) {
